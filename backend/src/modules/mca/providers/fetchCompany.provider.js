...
exports.fetchCompanyProvider = fetchCompanyProvider;
const apiClient_1 = __importDefault(require("../../../common/http/apiClient"));
const error_1 = require("../../../common/http/error");
function fetchCompanyProvider(payload) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
        try {
            // Mask company_id for logs (show only last 4)
            const maskedId = payload.company_id ? `******${payload.company_id.slice(-4)}` : undefined;
            console.log('Fetch Company API Request:', {
                url: '/mca-api/fetch-company',
                company_id: maskedId,
                consent: payload.consent,
                baseURL: process.env.GRIDLINES_BASE_URL,
            });
            const response = yield apiClient_1.default.post('/mca-api/fetch-company', payload);
            console.log('Fetch Company API Response:', {
            ...
            console.error('Fetch Company API Error:', {
            ...
            let errorMessage = 'Fetch Company failed';
            let statusCode = 500;
            if (error.code === 'ECONNABORTED' || (error.message || '').includes('timeout')) {
                ...
                errorMessage = 'Fetch Company endpoint not found';
                statusCode = 404;
            }
                ...
                if (((_m = (_l = (_k = error.response) === null || _k === void 0 ? void 0 : _k.data) === null || _l === void 0 ? void 0 : _l.error) === null || _m === void 0 ? void 0 : _m.code) === 'UPSTREAM_INTERNAL_SERVER_ERROR') {
                    errorMessage = 'Government source temporarily unavailable. Please try again later.';
                    statusCode = 503;
                }
                else {
