...
router.post('/v2/generate-otp', auth_1.authenticate, auth_1.requireUser, (0, middleware_1.validate)(schemas_1.aadhaarGenerateOtpV2Schema), aadhaar_controller_1.generateOtpV2Handler);
router.post('/v2/submit-otp', auth_1.authenticate, auth_1.requireUser, (0, middleware_1.validate)(schemas_1.aadhaarSubmitOtpV2Schema), aadhaar_controller_1.submitOtpV2Handler);
