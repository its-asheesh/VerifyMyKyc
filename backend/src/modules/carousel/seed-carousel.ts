...
const carouselData = [
  {
    ...
    description:
      'Hiring domestic help or personal staff is convenient but ensuring their trustworthiness is crucial. VerifyMyKyc is a digital identity verification platform tailored for individuals and households.',
  ...
  },
  {
    ...
    description:
      'Experience the fastest KYC verification in India. Our advanced AI technology processes documents instantly while maintaining the highest security standards.',
  ...
  },
  {
    ...
    description:
      'Stay compliant with regulatory requirements while providing seamless user experience. Our platform covers all major verification needs for businesses of any size.',
...
if (require.main === module) {
  mongoose
    .connect(process.env.MONGO_URI || 'mongodb://localhost:27017/verifymykyc')
    .then(() => {
