...
exports.listEmployersProvider = listEmployersProvider;
const apiClient_1 = __importDefault(require("../../../common/http/apiClient"));
const error_1 = require("../../../common/http/error");
function listEmployersProvider(transactionId) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d;
        try {
            const response = yield apiClient_1.default.get('/epfo-api/passbook/employers', {
                headers: { 'X-Transaction-ID': transactionId },
            });
            return response.data;
        }
        catch (error) {
            const message = ((_b = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'List employers failed';
