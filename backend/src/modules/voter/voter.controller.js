...
exports.voterOcrHandler = exports.voterMesonFetchHandler = exports.voterMesonInitHandler = exports.voterBosonFetchHandler = void 0;
...
exports.voterBosonFetchHandler = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user._id;
    const order = yield (0, quota_service_1.ensureVerificationQuota)(userId, 'voterid');
    if (!order)
        return res.status(403).json({ message: 'Verification quota exhausted or expired' });
    const result = yield service.bosonFetch(req.body);
...
exports.voterMesonFetchHandler = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.user._id;
    const order = yield (0, quota_service_1.ensureVerificationQuota)(userId, 'voterid');
    if (!order)
        return res.status(403).json({ message: 'Verification quota exhausted or expired' });
    const result = yield service.mesonFetch(req.body);
    yield (0, quota_service_1.consumeVerificationQuota)(order);
    res.json(result);
}));
// POST /api/voter/ocr (multipart)
exports.voterOcrHandler = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
