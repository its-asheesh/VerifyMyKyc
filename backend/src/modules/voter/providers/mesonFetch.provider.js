...
function voterMesonFetchProvider(payload) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield apiClient_1.default.post('/voter-api/meson/fetch', payload);
            return response.data;
        }
        catch (error) {
            throw new error_1.HTTPError(((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'Fetch Voter details (Meson) failed', ((_c = error.response) === null || _c === void 0 ? void 0 : _c.status) || 500, (_d = error.response) === null || _d === void 0 ? void 0 : _d.data);
        }
    });
}
