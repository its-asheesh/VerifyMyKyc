...
exports.checkPanAadhaarLinkProvider = checkPanAadhaarLinkProvider;
const apiClient_1 = __importDefault(require("../../../common/http/apiClient"));
const error_1 = require("../../../common/http/error");
function checkPanAadhaarLinkProvider(payload) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield apiClient_1.default.post('/pan-api/check-aadhaar-link', payload);
            ...
            throw new error_1.HTTPError(((_h = (_g = error.response) === null || _g === void 0 ? void 0 : _g.data) === null || _h === void 0 ? void 0 : _h.message) || 'Check PAN-Aadhaar Link failed', ((_j = error.response) === null || _j === void 0 ? void 0 : _j.status) || 500, (_k = error.response) === null || _k === void 0 ? void 0 : _k.data);
        }
    });
}
