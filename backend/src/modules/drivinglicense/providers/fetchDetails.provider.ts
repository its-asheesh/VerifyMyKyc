...
import {
  ...
  DrivingLicenseFetchDetailsResponse,
} from '../../../common/types/drivinglicense';

export async function fetchDrivingLicenseDetailsProvider(
  payload: DrivingLicenseFetchDetailsRequest,
): Promise<DrivingLicenseFetchDetailsResponse> {
