      ...
      >
        ...
        <div className="grid gap-6 sm:gap-8 lg:gap-10">
          ...
          <motion.section variants={itemVariants}>
            <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
              ...
              >
                ...
                {expandedSections.includes("acknowledgment") ? (
          ...
          <motion.section variants={itemVariants}>
            <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
              ...
              >
                ...
                {expandedSections.includes("disclaimer") ? (
                  <ChevronUp className="w-6 h-6 text-slate-500 flex-shrink-0" />
                ) : (
                  <ChevronDown className="w-6 h-6 text-slate-500 flex-shrink-0" />
                )}
          ...
          {[
            ...
            { id: "disputes", icon: MessageCircle, title: "Disputes Resolution" },
            { id: "eu-users", icon: Users, title: "For European Union (EU) Users" },
            { id: "severability", icon: RefreshCw, title: "Severability and Waiver" },
            { id: "translation", icon: BookOpen, title: "Translation Interpretation" },
            { id: "changes", icon: RefreshCw, title: "Changes to These Terms and Conditions" },
          ].map(({ id, icon: Icon, title }) => (
            <motion.section key={id} variants={itemVariants}>
              <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
                <div
                  className="flex items-center justify-between cursor-pointer p-6 sm:p-8 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                ...
                >
                  <div className="flex items-center">
                    <Icon className="w-6 h-6 sm:w-7 sm:h-7 text-blue-600 dark:text-blue-400 mr-4 flex-shrink-0" />
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-blue-700 dark:text-blue-400 text-balance">
                      {title}
                    </h2>
                  </div>
                ...
                <AnimatePresence>
                  {expandedSections.includes(id) && (
                    ...
                    >
                      <div className="prose prose-slate dark:prose-invert max-w-none prose-lg sm:prose-xl">
                        <p className="text-pretty">
                          {id === "governing-law" && "The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service."}
                          {id === "disputes" && "If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company."}
                          {id === "eu-users" && "If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident."}
                          {id === "severability" && "If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect."}
                          {id === "translation" && "These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute."}
                          {id === "changes" && "We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms."}
                        </p>
                      </div>
                    </motion.div>
                  )}
