        ...
        <div className="grid gap-6 sm:gap-8 lg:gap-10">
          ...
          <motion.section variants={itemVariants}>
            <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
              ...
              >
                ...
                {expandedSections.includes("external-links") ? (
                  <ChevronUp className="w-6 h-6 text-slate-500 flex-shrink-0" />
                ) : (
                  <ChevronDown className="w-6 h-6 text-slate-500 flex-shrink-0" />
                )}
          ...
          <motion.section variants={itemVariants}>
            <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
              <div
                className="flex items-center justify-between cursor-pointer p-6 sm:p-8 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                onClick={() => toggleSection("fair-use")}
              >
                <div className="flex items-center">
                  <Scale className="w-6 h-6 sm:w-7 sm:h-7 text-green-600 dark:text-green-400 mr-4 flex-shrink-0" />
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-blue-700 dark:text-blue-400 text-balance">
                    Fair Use Disclaimer
                  </h2>
                </div>
                {expandedSections.includes("fair-use") ? (
                  <ChevronUp className="w-6 h-6 text-slate-500 flex-shrink-0" />
                ) : (
                  <ChevronDown className="w-6 h-6 text-slate-500 flex-shrink-0" />
                )}
          ...
          <motion.section variants={itemVariants}>
            <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
              ...
              >
                <div className="flex items-center">
                  <MessageCircle className="w-6 h-6 sm:w-7 sm:h-7 text-purple-600 dark:text-purple-400 mr-4 flex-shrink-0" />
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-blue-700 dark:text-blue-400 text-balance">
          ...
          <motion.section variants={itemVariants}>
            <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
              <div
                className="flex items-center justify-between cursor-pointer p-6 sm:p-8 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                onClick={() => toggleSection("no-responsibility")}
              >
                <div className="flex items-center">
                  <Shield className="w-6 h-6 sm:w-7 sm:h-7 text-red-600 dark:text-red-400 mr-4 flex-shrink-0" />
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-blue-700 dark:text-blue-400 text-balance">
                    No Responsibility Disclaimer
                  </h2>
                </div>
                {expandedSections.includes("no-responsibility") ? (
                  <ChevronUp className="w-6 h-6 text-slate-500 flex-shrink-0" />
                ) : (
                  <ChevronDown className="w-6 h-6 text-slate-500 flex-shrink-0" />
                )}
          ...
          <motion.section variants={itemVariants}>
            <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl overflow-hidden">
              <div
                className="flex items-center justify-between cursor-pointer p-6 sm:p-8 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                onClick={() => toggleSection("use-at-your-own-risk")}
              >
                <div className="flex items-center">
                ...
                {expandedSections.includes("use-at-your-own-risk") ? (
                  <ChevronUp className="w-6 h-6 text-slate-500 flex-shrink-0" />
                ) : (
                  <ChevronDown className="w-6 h-6 text-slate-500 flex-shrink-0" />
                )}
